...
alias el="eza -lA"
alias ie="ELECTRON_SKIP_BINARY_DOWNLOAD= bunx @hyrious/install-electron"
alias df="duf --hide-mp '/dev, *com*, *ystem*'"
alias sm="smerge ."
alias nrb="NI_DEFAULT_AGENT=bun nr --if-present build"
alias nrsb="NI_DEFAULT_AGENT=bun nr --if-present storybook"
